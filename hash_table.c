...
const int HT_PRIME_1 = 31;
const int HT_PRIME_2 = 43;
...
static ht_hash_table* ht_new_sized(const int base_size) {
	...
	ht->count = 0;
	ht->items = calloc((size_t)ht->size, sizeof(ht_item*)); //fill allocated memory with NULL bytes, NULL entry in the array indicates that the bucket is empty
